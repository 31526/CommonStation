...
-- -----------------------------------------------------
-- Table `db2`.`user_login_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_login_log` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_login_log` (
...
-- Table `db2`.`follow`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`follow` ;

CREATE  TABLE IF NOT EXISTS `db2`.`follow` (
...
-- -----------------------------------------------------
-- Table `db2`.`follow_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`follow_group` ;

CREATE  TABLE IF NOT EXISTS `db2`.`follow_group` (
...
-- Table `db2`.`letter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`letter` ;

CREATE  TABLE IF NOT EXISTS `db2`.`letter` (
...
-- Table `db2`.`comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`comment` ;

CREATE  TABLE IF NOT EXISTS `db2`.`comment` (
...
-- Table `db2`.`gambit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`gambit` ;

CREATE  TABLE IF NOT EXISTS `db2`.`gambit` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`atme`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`atme` ;

CREATE  TABLE IF NOT EXISTS `db2`.`atme` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `db2`.`user_active`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_active` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_active` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`company`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`company` ;

CREATE  TABLE IF NOT EXISTS `db2`.`company` (
...
-- -----------------------------------------------------
-- Table `db2`.`company_scale`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`company_scale` ;

CREATE  TABLE IF NOT EXISTS `db2`.`company_scale` (
...
-- -----------------------------------------------------
-- Table `db2`.`company_industry`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`company_industry` ;

CREATE  TABLE IF NOT EXISTS `db2`.`company_industry` (
  `id` SMALLINT(5) UNSIGNED NOT NULL ,
...
-- -----------------------------------------------------
-- Table `db2`.`user_checkin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_checkin` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_checkin` (
...
-- -----------------------------------------------------
-- Table `db2`.`user_gold_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_gold_log` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_gold_log` (
...
-- Table `db2`.`channel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`channel` ;

CREATE  TABLE IF NOT EXISTS `db2`.`channel` (
...
-- Table `db2`.`classify`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`classify` ;

CREATE  TABLE IF NOT EXISTS `db2`.`classify` (
...
-- Table `db2`.`topic`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`topic` ;

CREATE  TABLE IF NOT EXISTS `db2`.`topic` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`tag` ;

CREATE  TABLE IF NOT EXISTS `db2`.`tag` (
...
-- Table `db2`.`feedback`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`feedback` ;

CREATE  TABLE IF NOT EXISTS `db2`.`feedback` (
...
-- -----------------------------------------------------
-- Table `db2`.`user_address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_address` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_address` (
...
-- Table `db2`.`lucky`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`lucky` ;

CREATE  TABLE IF NOT EXISTS `db2`.`lucky` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`medal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`medal` ;

CREATE  TABLE IF NOT EXISTS `db2`.`medal` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `db2`.`user_medal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_medal` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_medal` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`headline`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`headline` ;

CREATE  TABLE IF NOT EXISTS `db2`.`headline` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`picture`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`picture` ;

CREATE  TABLE IF NOT EXISTS `db2`.`picture` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- Table `db2`.`question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`question` ;

CREATE  TABLE IF NOT EXISTS `db2`.`question` (
...
-- Table `db2`.`answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`answer` ;

CREATE  TABLE IF NOT EXISTS `db2`.`answer` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
  `uid` INT(10) UNSIGNED NOT NULL DEFAULT 0 ,
  `nickname` CHAR(20) NOT NULL DEFAULT '' ,
...
-- Table `db2`.`bookmark`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`bookmark` ;

CREATE  TABLE IF NOT EXISTS `db2`.`bookmark` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `db2`.`user_bookmark`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`user_bookmark` ;

CREATE  TABLE IF NOT EXISTS `db2`.`user_bookmark` (
  `uid` INT(10) UNSIGNED NOT NULL DEFAULT 0 ,
...
-- -----------------------------------------------------
-- Table `db2`.`picture_album`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db2`.`picture_album` ;

CREATE  TABLE IF NOT EXISTS `db2`.`picture_album` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
  `uid` INT(10) UNSIGNED NOT NULL DEFAULT 0 ,
